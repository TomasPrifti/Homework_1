...
fetch("addRistoranti.php").then(onResponse, onError).then(onJson);
let myJson;
...
function formUpdate() {
    ...
    /* Problema sul passaggio dell'immagine (file) */
...
function createBlocks() {
    ...
    preferences.classList.add("flex", "hidden");
